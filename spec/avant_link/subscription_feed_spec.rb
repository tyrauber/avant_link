...
describe AvantLink::SubscriptionFeed, :vcr do
  ...
  pending "success" do
    let(:expectation){
      AvantLink::SubscriptionFeed.where(atts)
    }
  ...
  pending "required attributes" do
    it "auth_key" do
      expect { AvantLink::SubscriptionFeed.where(atts.merge!(auth_key: nil)) }.to raise_error(ArgumentError)
    end
    it "website_id" do
      expect { AvantLink::SubscriptionFeed.where(atts.merge!(website_id: nil)) }.to raise_error(ArgumentError)
    end
    it "affilate_id" do
      expect { AvantLink::SubscriptionFeed.where(atts.merge!(affiliate_id: nil)) }.to raise_error(ArgumentError)
    end
  end
end